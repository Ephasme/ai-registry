...
| **tools** | `nuke-branches` + _(n8n MCP server)_ | General utilities — git workflow helpers, plus n8n workflow automation via the [`n8n-mcp`](https://github.com/czlonkowski/n8n-mcp) server (node docs + validation out of the box; add your n8n URL + API key, prompted at install and stored in the keychain, to create, update, and run workflows). |
